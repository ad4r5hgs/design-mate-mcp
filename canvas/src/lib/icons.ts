/**
 * Lucide Icon Registry — 72 icons across 11 categories
 *
 * Each icon is stored as SVG innerHTML (the elements inside the <svg> tag).
 * All icons use: viewBox="0 0 24 24", fill="none", stroke="currentColor",
 * stroke-width="2", stroke-linecap="round", stroke-linejoin="round"
 *
 * Icons from Lucide v0.575.0 (ISC License)
 */
...
export const LUCIDE_ICONS: Record<string, string> = {
    ...
    "thumbs-up": '<path d="M7 10v12"/><path d="M15 5.88 14 10h5.83a2 2 0 0 1 1.92 2.56l-2.33 8A2 2 0 0 1 17.5 22H4a2 2 0 0 1-2-2v-8a2 2 0 0 1 2-2h2.76a2 2 0 0 0 1.79-1.11L12 2a3.13 3.13 0 0 1 3 3.88"/>',
    ...
    "rocket": '<path d="M4.5 16.5c-1.5 1.26-2 5-2 5s3.74-.5 5-2c.71-.84.7-2.13-.09-2.91a2.18 2.18 0 0 0-2.91-.09"/><path d="m12 15-3-3a22 22 0 0 1 2-3.95A12.88 12.88 0 0 1 22 2c0 2.72-.78 7.5-6 11a22.35 22.35 0 0 1-4 2"/>',
};

/** Get SVG innerHTML for an icon */
...
/** Get icon names grouped by category */
export function listIconsByCategory(): Record<string, string[]> {
    return {
